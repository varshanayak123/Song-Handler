...
const About = ({ onExploreMusic }) => {
  return (
    <div className='mx-auto min-h-[85vh] max-w-6xl px-4 pb-8 pt-28 sm:px-6 sm:pb-10 sm:pt-28 lg:px-8 lg:pb-12 lg:pt-32'>
      ...
      {/* Feature Cards Grid */}
      <div className='mb-10 grid grid-cols-1 gap-4 sm:mb-16 sm:gap-6 md:grid-cols-2 md:gap-8'>
        ...
        <div className='rounded-2xl border border-[#7B0D1E]/50 bg-[#3D1308] p-5 shadow-md transition-all duration-300 hover:border-[#9F2042] sm:p-8'>
          <div className='mb-4 flex h-9 items-center'>
            <svg
              ...
              viewBox='0 0 24 24'
              className='h-8 w-8 fill-none stroke-[#9F2042]'
              strokeWidth='1.8'
              strokeLinecap='round'
          ...
          <h2 className='mb-3 text-2xl font-bold text-[#F8E5EE]'>
            Discover Music
          </h2>

          <p className='leading-relaxed text-[#F8E5EE]/70'>
        ...
        <div className='rounded-2xl border border-[#7B0D1E]/50 bg-[#3D1308] p-5 shadow-md transition-all duration-300 hover:border-[#9F2042] sm:p-8'>
          <div className='mb-4 flex h-9 items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 24 24'
              className='h-9 w-9 fill-[#9F2042] stroke-[#9F2042]'
              strokeWidth='2'
              strokeLinecap='round'
              strokeLinejoin='round'
              aria-hidden='true'
      ...
      <div className='py-8 text-center'>
        <button
          ...
          className='w-full cursor-pointer rounded-full bg-[#9F2042] px-9 py-4 text-lg font-bold text-[#F8E5EE] shadow-xl transition-colors duration-200 hover:bg-[#7B0D1E] sm:w-auto'
        >
          Explore Music Now
        </button>
      </div>
