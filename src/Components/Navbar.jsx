    ...
    <div className='fixed top-0 left-0 right-0 z-50 flex items-center justify-between border-b border-[#7B0D1E]/40 bg-[#211103]/85 px-4 py-3 text-[#F8E5EE] shadow-md backdrop-blur-md sm:grid sm:grid-cols-[1fr_auto_1fr] sm:px-6 lg:px-10'>
      ...
      >
        ...
        >
          ...
          <path
            d="M30.5 10.5v18.25a6.25 6.25 0 1 1-3-5.33V15l-10 2.6v15.15a6.25 6.25 0 1 1-3-5.33V15.25Z"
            fill="#9F2042"
          />

          <path
            d="M19 12.5c1.45-1.45 3.1-2.18 5-2.18 4.1 0 7.43 3.25 7.43 7.27 0 1.67-.7 3.33-2.1 4.96"
            fill="none"
            stroke="#F8E5EE"
            strokeLinecap="round"
            strokeWidth="1.25"
        ...
        <span className='font-serif font-bold text-[#F8E5EE] text-xl tracking-[0.18em]'>
          MAE
        </span>
      </div>
      ...
      <div className='flex items-center justify-self-end gap-2 sm:gap-3'>
        ...
        {user && (
          <button
            ...
            className='hidden rounded-full border border-[#7B0D1E]/80 bg-[#3D1308] px-4 py-2 text-sm font-bold text-[#F8E5EE] transition-colors hover:border-[#9F2042] hover:text-[#9F2042] cursor-pointer sm:inline-flex'
          >
            Log Out
          </button>
        )}
      ...
      {isMobileMenuOpen && (
        <nav
          ...
          className='absolute left-4 right-4 top-full mt-2 rounded-2xl border border-[#7B0D1E]/70 bg-[#211103]/95 p-3 shadow-xl backdrop-blur-md sm:hidden'
        ...
        >
          ...
          <button
            ...
            className={`block w-full rounded-xl px-4 py-3 text-left font-bold transition-colors cursor-pointer ${
              currentView === 'home'
                ? 'bg-[#3D1308] text-[#9F2042]'
                : 'text-[#F8E5EE] hover:bg-[#3D1308] hover:text-[#9F2042]'
            }`}
          >
            Home
          </button>
          ...
          {!user ? (
            <button
              type="button"
              onClick={handleSignIn}
              className='mt-2 w-full rounded-full bg-[#9F2042] px-4 py-3 font-bold text-[#F8E5EE] transition-colors hover:bg-[#7B0D1E] cursor-pointer'
            >
              Sign In
            </button>
          ) : (
            <>
              <button
                type="button"
                onClick={handleProfile}
                className='mt-2 w-full rounded-full border border-[#7B0D1E]/80 bg-[#3D1308] px-4 py-3 font-bold text-[#F8E5EE] transition-colors hover:border-[#9F2042] hover:text-[#9F2042] cursor-pointer'
              >
                Profile
              </button>
